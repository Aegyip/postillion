...
fn format_reset_in(
    ...
    if minutes < 22 * 60 {
        // Birimler de çeviriden geliyor. Cümlenin başını çevirip "hr"/"min"i
        // gömmek Türkçede "Sıfırlanma 3 hr 20 min" veriyordu — yarısı
        // çevrilmiş bir satır, hiç çevrilmemişten kötü.
        let (hours, minutes) = (minutes / 60, minutes % 60);
        return Some(if hours > 0 {
            format!(
                "{} {hours} {} {minutes} {}",
                crate::i18n::t("Resets in"),
                crate::i18n::t("hr"),
                crate::i18n::t("min")
            )
        } else {
